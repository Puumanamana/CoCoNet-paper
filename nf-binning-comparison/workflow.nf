...
include { METABAT2 } from './modules/binning/metabat2/process' addParams(outdir: "$params.outdir/binning")
include { MAXBIN2 } from './modules/binning/maxbin2/process' addParams(outdir: "$params.outdir/binning")
